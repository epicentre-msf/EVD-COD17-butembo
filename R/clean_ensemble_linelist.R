clean_ensemble_linelist <- function(
  fn,
  root = here::here('Donnees'),
  out_root = here::here('Donnees', 'propre'),
  save = TRUE
) {
  out <- rio::import(
    here::here(root, fn),
    ...
    select(
      ...
      id = patient_site_id,
      # dates
      date = date_lab_result_1,
      date_exit = date_exit_eff,
      date_onset = date_symptom_onset,
      date_adm = date_admission_eff,
      date_notif = date_notification,
      date_sample = date_lab_sample_1,
      # places
      adm1 = adm1_name__notif,
      adm2 = adm2_name__notif,
      adm3 = adm3_name__notif,
      # demography
      age,
      age_unit,
      sex,
      ...
      inf_type_1 = transmission_type_1,
      inf_place_1 = transmission_place_1,
      inf_hf_1 = HF_name_transmission_1,
      inf_id_1 = infector_ID_1,
      inf_date_1 = date_transmission_1,
      inf_adm2_1 = adm2_name__transmission_1,
      inf_adm3_1 = adm3_name__transmission_1,
      inf_type_2 = transmission_type_2,
      inf_place_2 = transmission_place_2,
      inf_hf_2 = HF_name_transmission_2,
      inf_id_2 = infector_ID_2,
      inf_date_2 = date_transmission_2,
      inf_adm2_2 = adm2_name__transmission_2,
      inf_adm3_2 = adm3_name__transmission_2,
      narrative = narratif
    ) |>
    mutate(
  ...
  out_nowhere <- out |>
    ...
    rename(adm1_raw = adm1, adm2_raw = adm2, adm3_raw = adm3)
